...
Graph_Node_Iterator_Offset::Graph_Node_Iterator_Offset(std::vector<std::unique_ptr<Node>>& vec_input, size_t begin_input, size_t end_input, size_t thread_count){
    begin = begin_input;
    end = end_input;
...
size_t Graph_Node_Iterator_Offset::get_begin(){
    return begin;
}

size_t Graph_Node_Iterator_Offset::get_end(){
    return end;
}

const std::vector<size_t>& Graph_Node_Iterator_Offset::get_thread_limits(){
    return thread_limits;
}

const std::vector<u_int64_t>& Graph_Node_Iterator_Offset::get_prime_numbers(){
    return prime_numbers;
}

std::vector<std::unique_ptr<Node>>& Graph_Node_Iterator_Offset::get_vec(){
    return *vec;
}
